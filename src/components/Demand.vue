<template>
  <div class="demand" style="position: relative">
    ...
    <div class="main-first">
      ...
      <van-cell-group>
        <van-cell title="出行日期" value="选填" :value="date" @click="show = true" />
      </van-cell-group>
      <van-cell-group>
      ...
      <van-button round type="info" color="#27d461">免费获取旅行方案</van-button>
    </div>

    <!-- 点击日期出现的弹框 -->
    <van-calendar v-model:show="show" type="range" @confirm="onConfirm"  class="show-data" />
